...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = IRMV_V3_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # sensors
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(0.0, 1.2), lin_vel_y=(-0.0, 0.0), ang_vel_z=(-1.0, 1.0), heading=(-math.pi, math.pi)
        ),
    )
...
class EventCfg:
    ...
    add_base_mass = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="pelvis"),  # All joints above pelvis are fixed
...
@configclass
class IrmvFlatEnvCfg(ManagerBasedRLEnvCfg):
