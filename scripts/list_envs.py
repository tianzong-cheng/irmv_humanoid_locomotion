...
All the environments are registered in the `irmv_humanoid_locomotion` extension. They start
...
import irmv_humanoid_locomotion.tasks  # noqa: F401
from prettytable import PrettyTable


def main():
    """Print all environments registered in `irmv_humanoid_locomotion` extension."""
